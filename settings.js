...
module.exports = {
  // ===== BOT CORE SETTINGS =====
  SESSION_ID: process.env.SESSION_ID || "malvin~0iEBwY6A#Le4dfezS-8kQ0NBPIZXEZmqr-1uZVewrf5EYtLDUu9o", // Your bot's session ID (keep secure)
  PREFIX: getConfig("PREFIX") || ".", // Command prefix (e.g., ., /, !, *)
  CHATBOT: getConfig("CHATBOT") || "on", // Chatbot mode: on/off
  BOT_NAME: process.env.BOT_NAME || getConfig("FT_SY3D") || "ᴍᴀʟᴠɪɴ-xᴅ", // Bot display name
  ...
  OWNER_NUMBER: process.env.OWNER_NUMBER || "923118456830", // Owner WhatsApp number
  OWNER_NAME: process.env.OWNER_NAME || getConfig("SHAH_MIR") || "ᴍᴀʟᴠɪɴ ᴋɪɴɢ", // Owner name
